...
[System.Serializable]
public class Bliting : ScriptableRendererFeature
{
    [System.Serializable]
    class CustomRenderPass : ScriptableRenderPass
    {
        ...
        public override void Execute(ScriptableRenderContext context, ref RenderingData renderingData)
        {
            ...
            cmd.GetTemporaryRT(tempRenderTargetHandle.id, cam.pixelWidth, cam.pixelHeight, 0, FilterMode.Point);
    ...
    {
        m_ScriptablePass = new CustomRenderPass(settings.material, settings.Event);
